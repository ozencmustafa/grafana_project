...
response = requests.get("https://www.doviz.com/")web_html = response.text
...
file_path = os.path.relpath("/home/ubuntu/grafana_project/insert_csv_list.csv")
with open(file_path, "w", newline='') as file:
    writer = csv.writer(file)
    writer.writerows(list_to_convert)
    file.close()

cmd = '/home/ubuntu/grafana_project/regex_insert_zero.sh'
os.system(cmd)
